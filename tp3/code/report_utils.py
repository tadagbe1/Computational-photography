...
<body>
    ...
    <!-- Video Modal -->
    <div id="video-modal" class="lightbox" onclick="closeVideoModal(event)">
        <span class="lightbox-close">&times;</span>
        <div class="lightbox-content">
            <video id="video-modal-player" controls autoplay style="max-width:95vw; max-height:95vh; border-radius:10px; background:black;">
    ...
    <div class="container">
        ...
        <footer>
            <p>GIF 4105/7105 &mdash; TP2 | On s'amuse en fréquences</p>
        </footer>
    </div>
...
def figure_row(images_with_captions):
    html = """
    ...
    for img_path, caption in images_with_captions:
        ...
        <div style="text-align: center;">
            <img src="{img_path}" style="width: 250px; border-radius: 8px;">
            <p style="font-size: 0.9em; margin-top: 5px;">{caption}</p>
        </div>
        """
...
def figure_pile(img_path, caption, style="width: 80%;"):
    
    return f"""
    <div style="text-align:center; margin:20px 0;">
        <img src="{img_path}" alt="{caption}" style="{style}">
...
def video(src, caption="", width="320px", poster=None):
    """
    Affiche une petite vignette vidéo cliquable.
    Au clic, la vidéo s'ouvre en grand dans une modale.
    """
    caption_html = (
    ...
    <div style="text-align:center; margin:25px 0;">
        <div
            ...
            title="Cliquer pour voir la vidéo en grand"
        >
            <video
                {poster_attr}
                muted
        ...
        <div style="margin-top:8px; color:#999; font-size:0.92em;">
            Cliquer sur la vidéo pour l’ouvrir en grand
        </div>
        {caption_html}
    </div>
    """